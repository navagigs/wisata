          ...
          <?php
            ...
            if (isset($_POST['login'])) {
                ...
                if ($hasil > 0) {
                    ...
                    echo '<center><b style="color:red">Email atau Password SALAH!</b></center>';
                }
            }
            ?>
            ...
            <p>Baru disini? <a href="daftar.php">Klik Daftar</a> untuk membuat akun.</p>
            <input type="submit" name="login" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary right" value="Login">                
