...
if($_GET['mode']=='update'){
	$id_rumah_makan		= htmlentities($_POST['id_rumah_makan']);
	$nama_rumah_makan			= htmlentities($_POST['nama_rumah_makan']);
	...
	$query=mysql_query("UPDATE tb_rmmakan SET nama_rumah_makan='$nama_rumah_makan', alamat='$alamat', keterangan='$keterangan', harga='$harga', langitude='$langitude', latitude='$latitude',  image='$nama_file' WHERE id_rumah_makan='$id_rumah_makan'");
...
if($_GET['mode']=='edit'){
	$id_rumah_makan=$_GET['id'];
	$edit=mysql_query("SELECT * FROM tb_rmmakan WHERE id_rumah_makan='$id_rumah_makan'");
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <?php
								if($_GET['mode']=='edit'){
									?><form action="?page=rumah_makan_edit&mode=update" method="post" enctype="multipart/form-data"><?php 
								}
								else{
									?><form action="?page=rumah_makan_edit&mode=input" method="post" enctype="multipart/form-data">
