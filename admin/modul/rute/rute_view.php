 <div class="row">
            <div class="col-sm-12">
                <section class="panel">
					...
					//$sql=mysql_query("select * from tb_rute");
                    ...
                    <tr class="gradeU">
						...
						<a class="btn btn-warning" data-toggle="modal" href="?page=rute_hapus&id=<?php echo $data['Id_Rute'];?>" onClick="return confirm ('Apakah anda yakin untuk menghapus data ini')">Hapus</a>
