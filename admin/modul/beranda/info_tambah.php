                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <?php
                                if($_GET['mode']=='edit'){
                                    ?><form action="?page=info_tambah&mode=update" method="post" enctype="multipart/form-data"><?php 
                                }
                                else{
                                    ?><form action="?page=info_tambah&mode=input" method="post" enctype="multipart/form-data">
